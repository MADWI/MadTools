...
/**
 * This is the interface to the MicrophoneInput class for wrapping the audio
 * input.
 * 
...
public interface MicrophoneInputListener {
	 ...
	 * 
	 * @param audioFrame
	 *            this is an array of samples, e.g. if the sampling rate is 8000
	 *            samples per second, then the array should contain 160 16 bit
	 *            samples.
	 */
